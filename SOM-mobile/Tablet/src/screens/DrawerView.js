        ...
        return (
            <View style={{ margin: 20}}>
                <View style={{ paddingTop:20}}>
                    <Text style={{ fontSize:FONT_SIZE.TITLE, fontWeight:'bold'}}>
                        Account
                    </Text>
                </View>
    ...
    return (
        <DrawerContentScrollView {...props}   drawerStyle={{
              ...
              <View style={{ flexDirection: 'row', flex: 1, height: height }}>
                <View style={{backgroundColor: colors.white, flex: 1, borderRightWidth: 0.5, borderRightColor: colors.gray}}>
                    <View style={[styles.menuContranner, { marginTop: 30 }]}>
                        <Image source={require('../assets/images/logo-ptt.png')} style={{width:90,height:90}}/>
                    </View>
                    <TouchableOpacity onPress={() => onPressDrawer()} style={[styles.menuContranner, { marginTop: 5 }]}>
                        <Icon type="FontAwesome" name="bars" style={{ color: colors.grayButton, fontSize: 30 }}/>
                    </TouchableOpacity>
                   
                    <TouchableOpacity onPress={() => handleNavDrawer('HomeScreen')} style={[styles.menuContranner, { marginTop: 10}]}>
                        <Icon type="Ionicons" name="home-outline" style={{ color: colors.grayButton, fontSize: 30 }}/>
                        <Text>
                            Home
                        </Text>
                    </TouchableOpacity>
...

                    {
                        ...
                        <TouchableOpacity onPress={() => handleNavDrawer('SaleVisitPlanScreen','FE_PLAN_TRIP_S01')} style={styles.menuContranner}>
                            <Icon type="MaterialCommunityIcons" name="calendar-blank-outline" style={{ color: colors.grayButton, fontSize: 30 }}/>
                            <Text>
                                Sales visit plan 
                            </Text>
                        </TouchableOpacity>
...

                    {
                        ...
                        <TouchableOpacity onPress={() => handleNavDrawer('SaleVisitScreen','FE_VISIT_S01')} style={styles.menuContranner}>
                            <Icon type="SimpleLineIcons" name="location-pin" style={{ color: colors.grayButton, fontSize: 30 }}/>
                            <Text>
                                Sales visit
                            </Text>
                        </TouchableOpacity>
...

                    {
                        ...
                        <TouchableOpacity onPress={() => handleNavDrawer('SaleOrder','FE_SALEORD_S01')} style={styles.menuContranner}>
                            <Icon type="MaterialCommunityIcons" name="cart-outline" style={{ color: colors.grayButton, fontSize: 30 }}/>
                            <Text>
                                Sales order
                            </Text>
                        </TouchableOpacity>
...

                    {
                        ...
                        <TouchableOpacity onPress={() => handleWidthDrawer('MASTERDATA')} style={styles.menuContranner}>
                            <Icon type="MaterialCommunityIcons" name="resistor" style={{ color: colors.grayButton, fontSize: 30 }}/>
                            <Text>
                                Master Data
                            </Text>
                        </TouchableOpacity>
