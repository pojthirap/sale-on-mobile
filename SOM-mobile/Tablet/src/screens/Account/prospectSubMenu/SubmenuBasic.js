        ...
        <View style={{ flex: 1 }}>
            <ScrollView style={styles.container}>
                    ...
                    <View style={styles.titleLabel}>
                        <View style={{ flexDirection: 'row' }}>
                            ...
                            <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                                ...
                                <Switch
                                    value={selectted}
                                    onValueChange={handleSelectCustomer} style={{ marginLeft: 15 }}
                        ...
                        <View style={styles.title}>
                            <Text style={{ fontSize: FONT_SIZE.TEXT }}> New Account  </Text>
                        </View>
                        ...
                        <View style={styles.rowLabel}>
                            <View style={[styles.input, { flexDirection: 'row' }]}>
                                {/* <TextInput 
                                    title= {'Tax Number/ID Card'} 
                                    ref={el => inputRef.current.identifyId = el}
                                    value={dataBasic ? dataBasic.identifyId : ''} 
                                    type="Num" 
                                    maxLength={13}
                                ...
                                <View style={{ flex: 1 }}>
                                    <TextInput
                                        ...
                                        onChangeText={(dataInput) => {
                                            // let vatNumber = inputRef.current.vatNumber.getInputValue().value;
                                            // if(vatNumber && !dataInput) setDataIdentifyId(true)
                                ...
                                <View style={{ flex: 0.6, paddingTop: 32 }}>
                                    <TextInput
                                        TITLE={false}
                ...
                <View style={{ backgroundColor: colors.white, paddingBottom: 30 }}>
                    ...
                    {/* Button */}
                    <View style={{ flex: 1, flexDirection: 'row', paddingHorizontal: 20, justifyContent: 'center' }}>
                        {
                            handleButton() && <>
                                {
                                    handleButtonDelete() && <>
                                ...
                                <View style={[styles.buttonLow, { alignItems: handleButtonDelete() ? 'center' : 'flex-end' }]}>
                                    <Button
                                ...
                                <View style={[styles.buttonLow, { alignItems: handleButtonDelete() ? 'center' : 'flex-start' }]}>
                                    <Button
