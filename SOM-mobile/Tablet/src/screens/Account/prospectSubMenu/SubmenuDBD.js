            ...
            dataDbd &&             
                <ScrollView style={styles.container}>
                    <View style={{backgroundColor: colors.white}}>
                            ...
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    ...
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd ? dataDbd.firstName || '-' : ''} {dataDbd ? dataDbd.lastName || '' : ''}</Text>   
                                    </View>
                                </View>
                                <View style={styles.input}>
                                    <Text style={{fontWeight:'bold'}}>Contact Number</Text>
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.mobileNo ? dataDbd.mobileNo : '-'}</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    ...
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.accName ? dataDbd.accName : '-' }</Text>
                                    </View>
                                </View>
                                <View style={styles.input}>
                                    <Text style={{fontWeight:'bold'}}>Vat Number</Text>
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.identifyId ? dataDbd.identifyId : '-' }</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    ...
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.provinceNameTh ? dataDbd.provinceNameTh : '-' }</Text>
                                    </View>
                                </View>
                                <View style={styles.input}>
                                    <Text style={{fontWeight:'bold'}}>Code DBD</Text>
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.dbdCode ? dataDbd.dbdCode : '-' }</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    ...
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.dbdCorpType ? dataDbd.dbdCorpType : '-' }</Text>
                                    </View>
                                </View>
                                <View style={styles.input}>
                                    <Text style={{fontWeight:'bold'}}>Juristic Status</Text>
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd.dbdJuristicStatus ? dataDbd.dbdJuristicStatus : '-' }</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    ...
                                    <View style={{marginVertical: 10}}>
                                        <Text>{dataDbd ? dataDbd.latitude || '-' : ''}</Text>
                                    </View>
                                </View>
                                <View style={styles.input}>
                                    <Text style={{fontWeight:'bold'}}>Longitude</Text>
                                    <View>
                                        <Text>{dataDbd ? dataDbd.longitude || '-' : ''}</Text>
                                    </View>
                                </View>
                            </View>
                            <View style={styles.rowLabel}>
                        ...
                        {/* Button */}
                        <View style={{ flex: 1, flexDirection: 'row' ,paddingHorizontal: 20, justifyContent: 'center', marginBottom: 30}}>
                            {
                                handleButton() && <>
