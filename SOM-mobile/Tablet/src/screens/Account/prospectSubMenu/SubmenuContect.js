        ...
        <View style={{flex: 1, backgroundColor: colors.white}}>
            <ScrollView>
                <View style={styles.topLabel}>
                    ...
                    {
                        handleButton() && <View style={[styles.button, {flex: 1/2, alignItems: 'flex-end'}]}>
                            <Button
...

                {
                    ...
                    handleButton() && <View style={{ flex: 1, flexDirection: 'row' , justifyContent: 'center', marginHorizontal: "10%" }}>
