              ...
              <View style={{flexDirection:'row', justifyContent:'space-between',marginHorizontal:'5%',marginTop:'3%'}}>
                    ...
                    <View style={{flex:1/4}}>
                        {prospectSelectInfoReducer.dataSelect.isOther || prospectSelectInfoReducer.dataSelect.isRecommandBUProspect? 
                            null
                        : 
                            <Button title = {'Add'} typeIcon={'Ionicons'} nameIcon={'add-outline'} onPress={() => setmodalVisible(true)}/>
                        }
                    </View>           
                </View>
            ...
            >
                <View>
                    <View style={{flexDirection:'row',justifyContent:'space-between',marginVertical:'3%',marginHorizontal:'8%'}}>
                        ...
                        <View>
                            <Button title = {'Add'} typeIcon={'MaterialCommunityIcons'} nameIcon={'plus'} width={150} onPress={()=>setmodalVisibleAlertAdd(true)}/>
                        </View>
                    </View>

                    <View style={{marginHorizontal:'8%', borderBottomWidth:0.5, paddingBottom:40}}>
