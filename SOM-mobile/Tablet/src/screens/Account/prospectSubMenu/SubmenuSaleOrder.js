        ...
        <View style={{flex: 1, backgroundColor: colors.white}}>
            <ScrollView>
                ...
                <View style={styles.searchGroup}>
                    <View style={{flex: 2/5, marginHorizontal: 10, paddingBottom: 4}}>
                    ...
                    <View style={{flex: 1/4, marginHorizontal: 10, marginTop: 37}}>
                        <Button 
                            onPress={onSearch}
                            title={'Search'}
                            typeIcon={'Ionicons'}
                ...
                list.length != 0 ?
                    ...
                    renderItem = {(item) =>
                        <View style={{backgroundColor:colors.grayTable}}>
                                <Text style={{fontSize:25,margin:20}}>{item.item.date}</Text>
                                    <FlatList
                                        data = {item.item.data}
                                        renderItem = {(item) =>
                                        <TabSaleOrder
