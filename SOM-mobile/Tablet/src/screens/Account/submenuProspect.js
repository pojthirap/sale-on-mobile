...
import {ScrollView, View, StyleSheet, FlatList, BackHandler} from 'react-native';
...
const SubMenuProspect = () => {
    ...
    return (
        <View style={{flex:1}}>
            <Header/>
            <ScrollView>
                <View style={{marginBottom: 10, marginTop: 10, padding: 20}}>
                    <Text style={{fontSize: FONT_SIZE.HEADER, fontWeight:'bold'}}>{getTitle()}</Text>
                </View>           
                <View style={{justifyContent:'center', alignItems:'flex-start', marginStart: 15}}>
                    <FlatList
