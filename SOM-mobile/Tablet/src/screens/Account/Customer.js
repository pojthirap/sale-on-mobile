        ...
        <View style={styles.container}>
            <ScrollView >
                ...
                <View style={{ flex:1,marginTop:30,alignSelf:'center'}}>
                    <SearchInput ref={el => inputRef.current.search = el}  SearchBarType ={'SearchBarButton'} widthSearchBox={550} onPressSearch={()=>onSearch()}/>
                </View>
                <View style={{ flex: 1}}>
                    ...
                    <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', marginHorizontal:'3%',marginBottom:'3%'}}>
                        ...
                        <View>
                            <Text>หน้า {customerPage} ของ {customerReducer.dataCustomer ? Math.ceil(customerReducer.dataCustomer.totalRecords / 9) : 0}</Text>
                        </View>
                    </View>
                    {
                ...
                <View style={{flex:1,backgroundColor:colors.greenBGTerritory, justifyContent:'flex-end'}}>
                    <View style={{marginHorizontal:'3%', paddingTop:'8%'}}>
                        ...
                        <View>
                            <Text>หน้า {territoryPage} ของ {customerReducer.dataTerritory ? Math.ceil(customerReducer.dataTerritory.totalRecords / 9) : 0}</Text>
                        </View>
                        </View>
                    </View>
