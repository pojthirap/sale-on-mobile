        ...
        <ScrollView style={styles.container}>
            ...
            <View style={{ flex: 1}}>
                ...
                <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', marginHorizontal:'3%',marginBottom:'3%'}}>
                    ...
                    <View>
                        <Text>หน้า {myRentStationPage} ของ {rentStationReducer.dataRent ? Math.ceil(rentStationReducer.dataRent.totalRecords / 9) : 0}</Text>
                    </View>
                </View>
                ...
                <View style={{marginHorizontal:'3%', paddingTop:'8%'}}>
                    <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', marginBottom:'2%'}}>
                        ...
                        <View style={{flex:1, flexDirection:'row', justifyContent:'space-between',marginBottom:'3%'}}>
                            ...
                            <View>
                                <Text>หน้า {myInTerritoryPage} ของ {rentStationReducer.dataRentInTerritory ? Math.ceil(rentStationReducer.dataRentInTerritory.totalRecords / 9) : 0}</Text>
                            </View>
                        </View>
                    </View>
                <View style={{paddingBottom:'3%'}}>
