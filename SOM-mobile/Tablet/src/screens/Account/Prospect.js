        ...
        <ScrollView style={styles.container}>
            ...
            <View>
                ...
                <View style={{flex:1, flexDirection:'row', justifyContent:'space-between', marginHorizontal:'3%',marginBottom:'3%'}}>
                    ...
                    <View>
                    <Text>หน้า {myProspectPage} ของ {prospectReducer.dataMyProspect ? Math.ceil(prospectReducer.dataMyProspect.totalRecords / 9) : 0}</Text>
                    </View>
                </View>
                <View style={{paddingBottom:'3%'}}>
                {
                    ...
                    <View style={{alignSelf:'center', marginVertical:20}}>
                        <Text style={{fontSize:25,fontWeight:'bold'}}>ไม่พบข้อมูล</Text>
                    </View>
                }
                </View>
            </View>
            ...
            <View style={{flex:1,backgroundColor:colors.greenBGStatus}}>
                <View style={{marginHorizontal:'3%', paddingTop:'8%'}}>
                    ...
                    <View style={{flex:1, flexDirection:'row', justifyContent:'space-between',marginBottom:'3%'}}>
                        ...
                        <View>
                    <Text>หน้า {reccomentBUPage} ของ {prospectReducer.dataReccomentBU ? Math.ceil(prospectReducer.dataReccomentBU.totalRecords / 9) : 0}</Text>
                    </View>
                    </View>
                </View>
                <View style={{paddingBottom:'3%'}}>
            ...
            <View style={{flex:1,backgroundColor:colors.greenBGTerritory}}>
                <View style={{marginHorizontal:'3%',paddingTop:'8%'}}>
                    ...
                    <View style={{flex:1, flexDirection:'row', justifyContent:'space-between',marginBottom:'3%'}}>
                        ...
                        <View>
                        <Text>หน้า {myInTerritoryPage} ของ {prospectReducer.dataInTerritory ? Math.ceil(prospectReducer.dataInTerritory.totalRecords / 9) : 0}</Text>
                        </View>
                    </View>
                </View>
                <View style={{paddingBottom:'3%'}}>
