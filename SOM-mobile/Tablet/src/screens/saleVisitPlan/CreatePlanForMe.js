        ...
        <View style={{flex:1, backgroundColor: colors.white}}>
            ...
            <ScrollView>
                <View style={{marginBottom:50}}>
                    <View style = {{flexDirection:'row', marginHorizontal:40, marginBottom: 30, marginTop: 50}}>
                    ...
                    <View style={{ flexDirection: 'row', marginLeft: 30, alignItems: 'center', marginBottom: 20 }}>
                    ...
                    <View style = {{flexDirection:'row', marginHorizontal:40, marginBottom: 30}}>
                    ...
                    <View style={{flexDirection:'row' , justifyContent:'space-between', marginHorizontal:'3%', marginTop:20}}>
                        <View style={{flex: 1}}>
                            <SelectDropdown
                                startStop
                                TITLE={false}
                        ...
                        <View style={{flex: 0.6, alignItems: 'center', marginTop: 5, marginStart: '1%'}}>
                             <Button
                                onPress={() => handleClear()}
                                title={'Clear'}
                                typeIcon={'Ionicons'}
                    ...
                    <View style={{borderBottomWidth:0.5, borderColor: colors.gray, marginTop:60, marginBottom:30}}/>
