...
import { View, TouchableOpacity, StyleSheet, Alert, PermissionsAndroid } from 'react-native';
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{paddingHorizontal: '5%', marginTop: '5%'}}>
                ...
                {
                    locationAdd ?
                    <View style={{marginVertical: 10, height: 80, justifyContent: 'center', marginTop: 20}}>    
