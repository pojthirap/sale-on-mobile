        ...
        <View style={{flex: 1, backgroundColor: colors.white}}>
            ...
            <ScrollView style={{marginBottom: 10}}>
                <View style={[styles.SearchArea, styles.styleShadow]}>
                    <View style={{flexDirection: 'row', justifyContent: 'space-between', borderBottomWidth:0.5, borderColor:colors.grayborder, marginBottom: 30}}>
                    ...
                    <View style={{flexDirection: 'row', marginTop: 30, alignItems: 'center', marginBottom: 50}}>
                        <View style={{flex: 1, marginStart: '20%', marginEnd: '1%'}}>
                            <Button
                        ...
                        <View style={{flex: 1, marginStart: '1%', marginEnd: '20%'}}>
                            <Button
                                onPress={handleClear}
                                title={'Clear'}
                                typeIcon={'Ionicons'}
