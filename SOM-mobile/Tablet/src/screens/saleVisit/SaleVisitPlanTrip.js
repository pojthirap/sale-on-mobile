    ...
    return (
        <View style={{ flex: 1, backgroundColor: colors.white }}>
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} style={{ marginBottom: 30 }}>
                <Header />
                <View style={{ height: 320, backgroundColor: colors.grayborder, padding: 40 }}>
                    <Text style={{ fontSize: 35 }}>Good morning,</Text>
                    <Text style={{ fontSize: 55, fontWeight: 'bold' }}>Sales Visit</Text>
                </View>

                <View style={{ marginHorizontal: 25 }}>
                    <View style={{ marginHorizontal: 40, marginTop: isVisible ? bestRoutes.length == 1 ? (bestRoutes.length + 1) * 205 : bestRoutes.length < 4 ? (bestRoutes.length + 1) * 115 : bestRoutes.length == 4 ? (bestRoutes.length + 1) * 100 : (bestRoutes.length + 1) * 90 : 200 }}>
                        <Text style={{ fontSize: FONT_SIZE.HEADER, fontWeight: 'bold' }}>Today Plan Trip</Text>
                    </View>
                    <View style={{ marginHorizontal: 50, paddingBottom: 20 }}>
                        <Text style={{ fontSize: FONT_SIZE.SUBTITLE }}>กรุณา กด task เพื่อ Check in</Text>
                    </View>
                    ...
                    <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 30, marginTop: 30 }}>
                        <View>
                            <Button disabled={isComplete} title={'Ad-Hoc'} typeIcon={'Ionicons'} nameIcon={'add-outline'} width={200} onPress={() => {
                                setAdHocStart('')
                                setAdHocEnd('')
                                setIsShowModalAddPlan(true)
                            }} />
                        ...
                        <View>
                            <Button width={200} title={'Close'} fontColor={colors.primary} color={colors.white} onPress={() => navigation.goBack()} />
                        </View>
                    </View>
                </View>
                <View>
                    ...
                    >
                        ...
                        {/* {TimePicker}    */}
                        <View style={{ flexDirection: 'row', marginHorizontal: 20, marginBottom: 10, justifyContent: 'center', marginBottom: 20 }}>
                ...
                <View style={{ position: 'absolute', left: 30 }}>
                    <View style={[styles.styleShadow, styles.BestRouteBox]}>
                            ...
                            <View style={{ flex: 1 / 2 }}>
                                ...
                                <View style={{ flexDirection: 'row', paddingTop: 10 }}>
                                    <View style={{ alignSelf: 'center', paddingRight: 10 }}>
                                        <Text style={{ fontSize: 25, color: colors.primary, fontWeight: 'bold' }}>เลขไมล์</Text>
                                    </View>
                                    <View style={{ alignSelf: 'center' }}>
                                        <Input
                                            placeholder='ระบุเลขไมล์'
                                            placeholderTextColor={colors.gray}
                                            style={{ fontFamily: 'THSarabunNew', fontSize: 22, width: 100 }}
                        ...
                        {/* {Area 3} */}
                        <View style={{ flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 20, flex: 1 }}>
                            <View style={{ alignItems: 'center' }}>
                                <Text>ระยะทางรวมทั้งหมด</Text>
                                <Text>{numberWithCommas(parseInt(Math.ceil(totalKmSystem ? totalKmSystem : 0)))} กม.</Text>
                            </View>
                            <TouchableOpacity style={{ alignItems: 'center' }}>
                                <Button title={'Best Route'} width={250} onPress={onPressBestRoute} disabled={isComplete} />
                            </TouchableOpacity>
                        </View>
                            ...
                            <>
                                ...
                                <View style={{ paddingHorizontal: 30, paddingBottom: 10 }}>
                                    <View style={{ paddingBottom: 10 }}>
                                        <Text style={{ fontSize: FONT_SIZE.SUBTITLE, fontWeight: 'bold' }}>Best Route</Text>
                                    </View>
