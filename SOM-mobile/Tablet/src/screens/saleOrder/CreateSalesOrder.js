        ...
        <View style={styles.container}>
            <ScrollView>
                <View style={styles.alertTitle}>
                    <Text style={{color: colors.white,paddingHorizontal: 10,paddingVertical: 15,fontWeight:'bold',fontSize:FONT_SIZE.SUBTITLE}}>Create Sales Order</Text>
                ...
                <View>
                    <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:40, paddingBottom:20, paddingTop:30}}>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:40,paddingVertical:15}}>
                        <View style={{flex: 1/2, paddingRight:20}}>
                            <SelectDropdown
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:40,paddingVertical:15}}>
                        ...
                        {/* {DatePicker} */}
                        <View style={{flex: 1/2,paddingTop:5,paddingLeft:5}}>
                    ...
                    <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:40,paddingVertical:15}}>
                        ...
                        <View style={{flex: 1/2,paddingLeft:5}}>
                    ...
                    <View style={{flex: 1,marginHorizontal:40,paddingVertical:15}}>
                        <TextInput
                            title={'หมายเหตุ'}
                            maxLength={150}
                    ...
                    <View style={{flexDirection:'row',marginHorizontal:50,marginTop:70,justifyContent:'space-between'}}>
