...
const OverViewSaleOrder = ({},ref) => {
    ...
    return(
        <View style={styles.container}>        
            ...
            >
                {/* {Notification} */}
                <View style={[styles.styleShadow,{flex:1,backgroundColor:'white',margin:50, height:300, borderRadius:20}]}>
                    <ScrollView
                        nestedScrollEnabled
                    >
                ...
                <View style={{marginHorizontal:30,marginBottom:30}}>
                    <Text style={{fontSize:FONT_SIZE.TITLE,fontWeight:'bold'}}>ข้อความจาก SAP</Text>
                </View>

                <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:30, paddingBottom:20}}>
                    <View style={{flex: 1/2, paddingRight:25}}>
                        <View>
                        <SelectDropdown
                ...
                </View>
                {
                        ...
                        <View>
                            ...
                            <View style={{width:150, marginHorizontal:40, alignSelf:'flex-end'}}>
                                <Button
                                    title={'Close'}
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:30,paddingTop:20}}>
                    <View style={{flex: 1/2, paddingRight:25}}>
                        <SelectDropdown
                    ...
                    <View style={{flex: 1/2, paddingRight:25, justifyContent: 'flex-end'}}>
                         <Button
                ...
                <View style={{flexDirection:'row', justifyContent:'space-between', marginHorizontal:30, paddingBottom:20,paddingTop:20}}>
                    <View style={{flex: 1/2, paddingRight:25}}>
                        <SelectDropdown
                ...
                <View style={{justifyContent:'space-between', marginHorizontal:30,paddingBottom:20}}>
                    <View style={{flex: 1}}>
                        <TextInput
                            placeholder={isQuaNo === true ? '-' : ''}
                            editable = {isQuaNo === true ? false:true}
