    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{ marginHorizontal: 40, marginVertical: 20 }}>
                <Text style={{ fontSize: FONT_SIZE.HEADER, fontWeight: 'bold' }}>Sales Order</Text>
            </View>
            ...
            <View style={{ marginHorizontal: 40, marginVertical: 20 }}>
                <Text style={{ fontSize: FONT_SIZE.TITLE, fontWeight: 'bold' }}>Sales Order No. {salesOrderSelectInfoReducer.dataSelect.somOrderNo}</Text>
            </View>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'flex-end', marginHorizontal: 40, marginVertical: 25 }}>
                    <View style={{ paddingRight: 10, width: 170 }}>
