    ...
    return (
        <View style={{backgroundColor:'white',padding:20}}>
            <Header/>
                ...
                <View style={{flex:0.9}}>
                <Text style={{fontSize:FONT_SIZE.TITLE, fontWeight:'bold'}}>จดมิเตอร์</Text>
                </View>
                ...
                <View style={{flexDirection:'row',marginTop:10}}>
                    <View style={{flex:0.5,marginRight:20}}>
                        ...
                        {meter && meter.fileUrl ? <View>
                            <Image source={{uri:convertImage(meter.fileUrl)}} style={{marginTop:10,width:200,height:200}}/>
                            <TouchableOpacity onPress={()=>{
                             ...
                             <Text style={{ fontSize:FONT_SIZE.TEXT }}>ถ่ายภาพ</Text>
                                 <Image source={require('../../assets/images/ic_choose_camera.png')} style={{marginTop:10,width:100,height:100}}/>
                ...
                <View style={{flexDirection:'row',marginTop:10}}>
                 ...
                 {saveLoad ? <View style={{alignSelf:'center', marginBottom:50}}>
                <ActivityIndicator 
                            animating={true}
                            size="large" 
                            color={colors.primary}/>
                </View>  : <TouchableOpacity disabled={!isSave} style={{alignSelf:'center',marginBottom:20,backgroundColor:isSave ? colors.primary : colors.disabled,padding:15,borderRadius:10,marginBottom:120,marginTop:20}} onPress={()=> onSave()}>
