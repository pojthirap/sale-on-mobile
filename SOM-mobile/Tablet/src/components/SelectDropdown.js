                        ...
                        <>
                            <View style={{ flexDirection: 'row' }}>
                                <View style={{ paddingRight: '3%', justifyContent: 'center' }}>
                                    <Text style={{ fontSize: 25, color: colors.primary, fontWeight: 'bold' }}>{titleDropdown}</Text>
                                </View>
                                <View style={{ flex: 1 }}>
                                    <TouchableOpacity
                                        onPress={() => onPressModal(true)}
                                    ...
                                    >
                                        <View style={{ flexDirection: 'row', flex: 1, justifyContent: 'space-between' }}>
                                            <View style={{ marginRight: 5, flex: 1 }}>
                                                <Text style={{ color: userSelect ? colors.black : colors.gray }} numberOfLines={1}>{userSelect || placeholderValue}</Text>
                                            </View>
                                            <View>
