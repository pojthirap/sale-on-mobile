...
const Filter = ({onPress,select}, ref) =>{
    ...
    return(
        <View>
            <TouchableOpacity onPress={()=>setFilter(true)}>  
                <View style={{flexDirection:'row'}}>
                    <View style={{alignSelf:'center'}}>
                        <Icon type='MaterialCommunityIcons' name='filter-outline' style={{color: colors.grayButton,fontSize:30}}/>
                    </View>
                    <View style={{alignSelf:'center'}}>
                        <Text style={{fontSize:FONT_SIZE.TEXT}}>ตัวกรอง</Text>
                    </View>
                </View>
            </TouchableOpacity>
            <Modal
            ...
            >
                <View style={{marginHorizontal:50,marginTop:20,marginBottom:30}}>
