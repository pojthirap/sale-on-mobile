        ...
        <View style={{ flex: 1, backgroundColor: colors.white }}>                
            <View style={{backgroundColor: colors.white, marginBottom: 30}}>
                ...
                <View style={styles.titleLabel}>
                    ...
                    CREATEPROSPECT ?
                        <View style={styles.title}>
                            <Text style={{ fontSize: FONT_SIZE.TEXT }}>{textDetail} </Text>
                        </View>
                    :
                        null
                    }
                    ...
                    SA ?
                        ...
                        ADDRESSCUSTOMER ?
                            <View style={styles.rowLabel}>
                                {/* <View style={styles.input}>
                                    <TextInput title={'ประเภท Address'} editable={editable} ref={el => inputRef.current.name = el} maxLength={5}/>
                                </View> */}
                    ...
                    CREATEPROSPECT ?
                        <View>
                            ...
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    <SelectDropdown
                                        // defaultValue={provinceName ? provinceName[0].provinceCode : ''}
                        ...
                        <View>
                            <View style={styles.rowLabel}>
                                <View style={styles.input}>
                                    <View style={{flex: 1}}>
                                        <TextInput
                                            // value={addressTab ? addressTab[indexAddress || 0].latitude : basicTab ? (JSON.stringify(location.latitude) || basicTab.latitude) : saTab ? saTab.latitude : '' } 
                                ...
                                <View style={styles.lalongLabel}>
                                    <View style={{flex: 1, paddingEnd: 10}}>
                                        <TextInput 
                                            // value={addressTab ? addressTab[indexAddress || 0].longitude : basicTab ? (JSON.stringify(location.longitude) || basicTab.longitude) : saTab? saTab.longitude : ''} 
                            ...
                            <View style={styles.rowLabel}>
                                <View style={[styles.input,{marginRight:30}]}>
                                    <TextInput 
