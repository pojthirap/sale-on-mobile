...
const CardTerritory = ({Rep = true,
    ...
    const cardItem = (items) => {
        return (
            <View style={[styles.CardArea,{marginHorizontal: Rep ? '15%':'10%',marginBottom: '1%', width: Rep ? 250 : 200}]}>
                <View style={{paddingHorizontal:'10%',flexDirection:'row',justifyContent:'space-between',paddingTop:'10%',paddingBottom:'5%'}}>
                    { Rep ? 
    ...
    return (
        <ScrollView>
            <View style={{flex:1,margin:'2%'}} >
                <View style={[styles.BGArea, {paddingBottom:'10%'}]}>
                ...
                <View style={{flexDirection:'row',justifyContent:'space-between'}}>
                        <View style = {{alignSelf:'center', marginBottom:'3%'}}>
                            ...
                            <View style={{flexDirection:'row'}}>
                                ...
                                <Text style={{fontSize: 25, color:colors.primary, fontWeight:'bold'}}> ({getLength()})</Text> 
                            </View>
                            {/* // :
                            // <>
                            // <Text style={{fontSize:25, fontWeight:'bold'}}>{Title}</Text>
