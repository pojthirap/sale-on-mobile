      ...
      return (
        <View style={[styles.itemTable,{ alignItems:'center', justifyContent:'center'}]}>
            <TouchableOpacity onPress={() => {
              ...
              <Icon type="Ionicons" name="qr-code-outline" style={{ color: colors.grayDark, fontSize:25 }}/>
            </TouchableOpacity>
        </View>
      )
    }
      ...
      return (
        <View style={[styles.container, {marginHorizontal : spaceHorizontal}]}>
            ...
            }
            {
              ...
              null
              :
              <View style={{ justifyContent: 'space-between', flexDirection: 'row', alignItems: 'center',  paddingRight: 60, paddingLeft:30 }}>
                  <View style={{ flex: 1 }}>
                      <Text>
                              ...
                              <ScrollView>
                                ...
                                <DefaultModal transparent={true} visible={isShowFullTable == true && visiblePageSelect == true}>
                                  <ScrollView
                                      ...
                                      <ScrollView style={{ marginRight: 150, backgroundColor: 'white'}}>
                                        {
                                          nubmerPageArray.map((page, index) => {
                                            return <Menu.Item onPress={() => {
                                                onPageChange(page)
            ...
            <ViewShot 
              ...
              <View style={{ justifyContent: 'center', alignItems: 'center', marginTop:50, marginBottom:20, backgroundColor: 'white', padding: 10 }}>
                <QRCode
                  getRef={(c) => setSvg(c)}
                  value={qrData}
                  size={250}
                ...
                <View style={{marginTop: 30, marginHorizontal: '10%'}}>
                  <Text style={{fontWeight: 'bold', fontSize: FONT_SIZE.SUBTITLE}}>ชื่อลูกค้า  :  {qrDetail.custNameTh}</Text>
                  <Text style={{fontWeight: 'bold', fontSize: FONT_SIZE.SUBTITLE}}>ประเภทผลิตภัณฑ์  :  {qrDetail.gasNameTh}</Text>
                  <Text style={{fontWeight: 'bold', fontSize: FONT_SIZE.SUBTITLE}}>ตู้น้ำมัน  :  {qrDetail.dispenserNo}</Text>
                  <Text style={{fontWeight: 'bold', fontSize: FONT_SIZE.SUBTITLE}}>มือจ่ายที่  :  {qrDetail.nozzleNo}</Text>
                </View>
              </View>
            </ViewShot>
            <TouchableOpacity style={{alignSelf:'flex-end', marginHorizontal:80, marginBottom:30}} onPress={() => {
              onShare(qrData)
              onPressCap()
              }}>
                <View style={{justifyContent:'center'}}>
                  <View style={{alignSelf:'center'}}>
                    <Icon type='Ionicons' name='share-outline' style={{fontSize:30}}/>
                  </View>
                  <View style={{alignSelf:'center'}}>
                    <Text>Share</Text>
                  </View> 
