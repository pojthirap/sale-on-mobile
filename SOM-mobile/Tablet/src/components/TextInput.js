...
const TextField = ({
  ...
  const onChange = (value) => {
    ...
    if (type == 'Freetext' && !Freetext.test(value)) return
    // if (type == 'NumFloat' && value.includes('.')) {
    //   let fff = value.split('.')
    //   if (fff.length && fff[1].length > 2) return 
    // }
                ...
                <View style={{ position: 'absolute', top: 15, right: 20}}>
                  {
                    ...
                    <TouchableOpacity onPress={() => onPressVisiblePass()}  style={{}} >
                      <Icon type="MaterialCommunityIcons" name="eye"style={{fontSize:35}}/> 
                    </TouchableOpacity>
                    :
                    <TouchableOpacity onPress={() => onPressVisiblePass()}  style={{}} >
                      <Icon type="MaterialCommunityIcons" name="eye-off"style={{fontSize:35}}/> 
                    </TouchableOpacity>
                  }
                </View>
                : 
