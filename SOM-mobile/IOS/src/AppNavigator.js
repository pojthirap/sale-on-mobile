...
const App = () => {
  ...
  const [isGetToken, setIsGetToken] = React.useState(false);
  ...
  function AccountTab() {
    return (
      ...
      >
        <Tab.Screen name="SubmenuSAScreen" component={SubmenuSAScreen} />
        <Tab.Screen name="SubmenuFeedScreen" component={SubmenuFeedScreen} />
        <Tab.Screen name="SaleTerritoryScreen" component={SaleTerritoryScreen} />
        <Tab.Screen name="SubmenuAddressScreen" component={SubmenuAddressScreen} />
        <Tab.Screen name="SubmenuContectScreen" component={SubmenuContectScreen} />
        <Tab.Screen name="SubmenuAttachScreen" component={SubmenuAttachScreen} />
        <Tab.Screen name="SubmenuVisitHourScreen" component={SubmenuVisitHourScreen} />
        <Tab.Screen name="SubmenuSurveyResultsScreen" component={SubmenuSurveyResultsScreen} />
        <Tab.Screen name="SubmenuRecommandBUScreen" component={SubmenuRecommandBUScreen} />
        <Tab.Screen name="SubmenuTemplateSaScreen" component={SubmenuTemplateSaScreen} />
        <Tab.Screen name="SubmenuDbdScreen" component={SubmenuDbdScreen} />
        <Tab.Screen name="SubmenuAccTeamScreen" component={SubmenuAccTeamScreen} />
        <Tab.Screen name="SubmenuBasicScreen" component={SubmenuBasicScreen} />
        <Tab.Screen name="SubmenuSaleOrderScreen" component={SubmenuSaleOrderScreen} />
        <Tab.Screen name="SubmenuMeterScreen" component={SubmenuMeterScreen} />
        <Tab.Screen name="SubmenuStockCountScreen" component={SubmenuStockCountScreen} />
        <Tab.Screen name="SubmenuSalesDataScreen" component={SubmenuSalesDataScreen} />
      </Tab.Navigator>
    );
  }
